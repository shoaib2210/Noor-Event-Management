<%@ WebHandler Language="C#" Class="DecoratorImage" %>
...
public class DecoratorImage : IHttpHandler {
    ...
    public void ProcessRequest(HttpContext context)
    {
        if (context.Request.Files.Count > 0)
        {
            ...
            string path1 = context.Server.MapPath("DecoratorImage/" + timeStamp + ".jpg");
            ...
            context.Response.ContentType = "text/plain";
            context.Response.Write("DecoratorImage/" + timeStamp + ".jpg");
        }
    }
