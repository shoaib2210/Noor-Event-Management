<%@ WebHandler Language="C#" Class="HallImage" %>
...
public class HallImage : IHttpHandler {
    ...
    public void ProcessRequest(HttpContext context)
    {
        if (context.Request.Files.Count > 0)
        {
            ...
            string path1 = context.Server.MapPath("HallImage/" + timeStamp + ".jpg");
            ...
            context.Response.ContentType = "text/plain";
            context.Response.Write("HallImage/" + timeStamp + ".jpg");
        }
    }
