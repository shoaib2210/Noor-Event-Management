<%@ WebHandler Language="C#" Class="CaterImage" %>
...
public class CaterImage : IHttpHandler {
    ...
    public void ProcessRequest(HttpContext context)
    {
        if (context.Request.Files.Count > 0)
        {
            ...
            string path1 = context.Server.MapPath("CaterImage/" + timeStamp + ".jpg");
            ...
            context.Response.ContentType = "text/plain";
            context.Response.Write("CaterImage/" + timeStamp + ".jpg");
        }
    }
